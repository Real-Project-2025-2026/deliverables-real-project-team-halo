-- Migration: Add function to search users by username or email
-- Description: Creates a function that searches for users by username (in profiles) or email (in auth.users)
-- This allows users to find each other by email address for Guardian requests
