-- Migration: Fix type mismatch in search_users_by_username_or_email function
-- Description: Casts VARCHAR columns to text to match function return type

-- Function to search users by username or email
-- Uses SECURITY DEFINER to access auth.users table
-- Fixed: Explicitly casts VARCHAR columns to text to match return type
